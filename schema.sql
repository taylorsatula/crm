...
-- ticket_closeouts
-- -----------------------------------------------------------------------------
-- Canonical structured reconciliation for completed service appointments.
-- Quoted ticket line items remain the baseline; this aggregate stores the
-- decision record and the final billed snapshot produced from exceptions.
-- -----------------------------------------------------------------------------
...
-- -----------------------------------------------------------------------------
-- Immutable quote/final snapshots. The mutable line_items rows carry the final
-- billable quantities and prices, while this table preserves the quoted state.
-- -----------------------------------------------------------------------------
...
-- -----------------------------------------------------------------------------
-- Provenance-bearing customer-history facts captured during the office debrief.
-- -----------------------------------------------------------------------------
...
-- -----------------------------------------------------------------------------
-- Non-exact future service and reminder plans. Exact bookings are tickets.
-- -----------------------------------------------------------------------------
...
-- -----------------------------------------------------------------------------
-- Executable business or customer obligations created by one closeout.
-- -----------------------------------------------------------------------------
...
-- -----------------------------------------------------------------------------
-- square_sales and square_import_links
-- -----------------------------------------------------------------------------
-- Immutable Square commerce history is distinct from operational tickets.
-- A sale can be conservatively linked to a ticket without pretending Square
-- supplied a booking/order foreign key.
-- -----------------------------------------------------------------------------
...
-- Expected: CRM tables created successfully.
-- =============================================================================
