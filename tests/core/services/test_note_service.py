...
class TestNoteCreate:
    ...
    def test_creates_customer_note(self, db, as_test_workspace, note_service, test_customer):
    ...
    def test_creates_ticket_note(self, db, as_test_workspace, note_service, test_ticket):
    ...
    def test_rejects_no_parent(self, db, as_test_workspace, note_service):
    ...
    def test_rejects_both_parents(self, db, as_test_workspace, note_service, test_customer, test_ticket):
...
class TestNoteGet:
    ...
    def test_gets_note(self, db, as_test_workspace, note_service, test_customer):
        """Gets note by ID."""
        from core.models import NoteCreate
    ...
    def test_returns_none_for_missing(self, db, as_test_workspace, note_service):
...
class TestNoteList:
    ...
    def test_lists_customer_notes(self, db, as_test_workspace, note_service, test_customer):
    ...
    def test_lists_ticket_notes(self, db, as_test_workspace, note_service, test_ticket):
    ...
    def test_excludes_deleted_notes(self, db, as_test_workspace, note_service, test_customer):
...
class TestNoteDelete:
    ...
    def test_deletes_note(self, db, as_test_workspace, note_service, test_customer):
        """Soft deletes note."""
        from core.models import NoteCreate
    ...
    def test_returns_false_for_missing(self, db, as_test_workspace, note_service):
...
class TestNoteProcessed:
    ...
    def test_mark_processed(self, db, as_test_workspace, note_service, test_customer):
    ...
    def test_list_unprocessed(self, db, as_test_workspace, note_service, test_customer):
    ...
    def test_list_unprocessed_for_ticket(self, db, as_test_workspace, note_service, test_customer, test_ticket):
    ...
    def test_list_unprocessed_for_ticket_empty(self, db, as_test_workspace, note_service, test_ticket):
        """Returns empty list when ticket has no unprocessed notes."""
        result = note_service.list_unprocessed_for_ticket(test_ticket.id)
        assert result == []

    def test_list_unprocessed_for_ticket_excludes_deleted(self, db, as_test_workspace, note_service, test_ticket):
...
class TestNoteEventPublishing:
    ...
    def test_create_publishes_note_created(self, db, as_test_workspace, note_service, event_bus, test_customer):
        from core.models import NoteCreate
